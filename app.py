...
grafico = Figure(pie(banco,title="Comparativo da eficiência na ultilização de celulares na sala de aula",names="Estado",values="Eficiência",hole=0.7,height=700,width=700))
...
grafico = Figure(pie(banco,title="Comparativo da eficiência entre alunos que realizam tarefas dentro do prazo determinado",names="Estado",values="Eficiência",hole=0.7,height=700,width=700))
st.plotly_chart(grafico,use_container_width=True)
...
grafico = Figure(pie(banco,title="Comparativo entre alunos estudando materias que gostam",names="Estado",values="Eficiência",hole=0.7,height=700,width=700))
st.plotly_chart(grafico,use_container_width=True)
...
grafico = Figure(pie(banco,title="Comparativo das medias entre salas que usam linguagem ofensivas",names="Estado",values="Eficiência",hole=0.7,height=700,width=700))
st.plotly_chart(grafico,use_container_width=True)
...
grafico = Figure(pie(banco,title="Comparativo entre atividades em ambientes silênciosos",names="Estado",values="Eficiência",hole=0.7,height=700,width=700))
st.plotly_chart(grafico,use_container_width=True)
...
grafico = Figure(pie(banco,title="Comparativo alunos que prestam atenção e participam ativamente das aulas",names="Estado",values="Eficiência",hole=0.7,height=700,width=700))
st.plotly_chart(grafico,use_container_width=True)
...
grafico = Figure(pie(banco,title="Comparativo entre escolas que utilizam tecnologia a favor do ensino",names="Estado",values="Eficiência",hole=0.7,height=700,width=700))
st.plotly_chart(grafico,use_container_width=True)
